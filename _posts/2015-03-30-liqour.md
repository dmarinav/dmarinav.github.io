...
My final model excluded the month when liquor was purchased, I adjusted density of the data points by removing category Month from my data. As seen next, regrouping the data substantially decreased MSE (mean squared error) of the final regression model. 
...
![Regression Table]({{ site.url }}{{ site.baseurl }}/images/table2_1.png){: .align-center}
