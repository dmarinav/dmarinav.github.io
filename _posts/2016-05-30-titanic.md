...
After performing all these techniques, I obtained a 99.08% accuracy score on my training set and 91.57% on my test set. Below are the confusion matrices for training, test, and complete data sets.
