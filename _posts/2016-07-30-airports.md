...
[![Eigenvalues]({{ site.url }}{{ site.baseurl }}/images/pic5_2x.png)]({{ site.url }}{{ site.baseurl }}/images/pic5_2x.png)
...
[![Major Components]({{ site.url }}{{ site.baseurl }}/images/pic5_3x.png)]({{ site.url }}{{ site.baseurl }}/images/pic5_3.png)

[![Major Components]({{ site.url }}{{ site.baseurl }}/images/pic5_3.png)]({{ site.url }}{{ site.baseurl }}/images/pic5_3x.png)

[![Major Components]({{ site.url }}{{ site.baseurl }}/images/pic5_3x.png)]({{ site.url }}{{ site.baseurl }}/images/pic5_3x.png)
...
[![Inertia Values]({{ site.url }}{{ site.baseurl }}/images/pic5_4x.png)]({{ site.url }}{{ site.baseurl }}/images/pic5_4x.png)
...
[![Silhouette plot 1]({{ site.url }}{{ site.baseurl }}/images/pic5_5x.png)]({{ site.url }}{{ site.baseurl }}/images/pic5_5x.png)
...
[![DBSCAN]({{ site.url }}{{ site.baseurl }}/images/pic5_13x.png)]({{ site.url }}{{ site.baseurl }}/images/pic5_13x.png)
